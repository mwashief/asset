...
COMMENT ON TABLE asset IS 'All the assest class';

COMMENT
    ON TABLE asset_delta IS 'History of assest changing over time';

COMMENT
    ON COLUMN asset_delta.delta IS 'What is the change of this asset';